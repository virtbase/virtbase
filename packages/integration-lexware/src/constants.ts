...
/** The seller's own country; everything else is invoiced under OSS rules. */
export const HOME_COUNTRY = "DE" as const;

export type ContactCountry = keyof typeof COUNTRY_CONTACTS;
