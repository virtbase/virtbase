...
/**
 * Stand-in until `@virtbase/observability` exists. Matches the `console.*`
 * calls integrations make today, so extraction changes no log output.
 */
export const consoleLogger: IntegrationLogger = {
