 ...
 */
export const localizePowerDns = async (): Promise<LocalizedIntegrationText> => {
  ...
  return {
    ...
    fields: {
      apiUrl: {
        label: t("API URL"),
        help: t("Base URL of the PowerDNS HTTP API, without a trailing slash."),
      },
      apiKey: {
        label: t("API key"),
        help: t("Sent as the X-API-Key header."),
      },
    },
  };
};
