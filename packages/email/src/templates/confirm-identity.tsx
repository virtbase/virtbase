...
/**
 * The re-authentication code for an account with no password and no passkey.
 *
 * Deliberately separate from `verify-email`, which carries the same kind of
 * code for a different reason: one confirms a new address, this one confirms a
 * person before something irreversible happens to their data. Two subjects in
 * an inbox beat one ambiguous one.
 */
export default async function ConfirmIdentity({
