...
import { InvoicesCard } from "@/features/invoices/components/invoices-card";
...
export default function Page({
  searchParams,
}: PageProps<"/app.virtbase.com/[locale]/invoices">) {
  ...
  return (
    <DashboardLayout
      leftSide={
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbPage>{t("Invoices")}</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      }
    >
      ...
      >
        <InvoicesCard searchParams={searchParams} />
      </Suspense>
    </DashboardLayout>
  );
}
