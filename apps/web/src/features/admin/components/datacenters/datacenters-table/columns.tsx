...
export type DatacentersTableColumn = Awaited<
    ...
    },
    {
      ...
      cell: ({ cell }) => (
        <NextLink
          ...
          href={paths.admin.datacenters.overview.getHref(cell.row.original.id)}
          prefetch={false}
        >
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-40">
              <DropdownMenuItem asChild>
                <NextLink
                  href={paths.admin.datacenters.overview.getHref(
                    row.original.id,
                  )}
                  prefetch={false}
                >
